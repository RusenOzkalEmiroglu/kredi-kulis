...
export default function EditCarouselPage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    async function fetchCarousel() {
      try {
        ...
        setError('Carousel yüklenirken bir hata oluştu: ' + error.message);
      } finally {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Carousel güncellenirken bir hata oluştu: ' + error.message);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-bold">Carousel Düzenle</h2>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          <div className="mb-2">
            <img src={imageUrl} alt="Current" className="h-24 object-cover" />
          </div>
          <input
            type="file"
            accept="image/*"
