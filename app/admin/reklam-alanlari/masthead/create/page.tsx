...
export default function CreateMastheadPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/masthead', {
        method: 'POST',
        headers: {
      ...
      setError('Masthead eklenirken bir hata oluştu: ' + error.message);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-bold">Yeni Masthead Ekle</h2>
